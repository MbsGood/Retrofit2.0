...
public class RoundAngleGJImageView
    extends GJImageView
{
    private Paint paint;
    ...
    public RoundAngleGJImageView(Context context, AttributeSet attrs, int defStyle)
    {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public RoundAngleGJImageView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context, attrs);
    }

    public RoundAngleGJImageView(Context context)
    {
        super(context);
        init(context, null);
    }

    public void setRoundAngle(int roundWidth, int roundHeight)
    {
